package co.edu.ufps.ejemplojsf.util;
...
public class Conexion<T> {
	...
	public static EntityManager getEm(){
		if ( em == null ) {
			EntityManagerFactory emf = Persistence.createEntityManagerFactory("ejemplojsf");
            em = emf.createEntityManager();
        }
		return em;
	}
	
	public <E> T find(String id){
		T object = (T) em.find(c, id);
		return object;
	}
	
	public <E> T findName(int id){
		T object = (T) em.find(c, id);
		return object;
	}
